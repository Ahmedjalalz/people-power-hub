...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PeopleLens — HR Insights" },
      { name: "description", content: "Simple, human HR insights and attrition prediction." },
      { property: "og:title", content: "PeopleLens — HR Insights" },
      { property: "og:description", content: "Simple, human HR insights and attrition prediction." },
